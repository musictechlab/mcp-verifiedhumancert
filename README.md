...
[![CI](https://github.com/musictechlab/mcp-verifiedhumancert/actions/workflows/ci.yml/badge.svg)](https://github.com/musictechlab/mcp-verifiedhumancert/actions/workflows/ci.yml)
...
```bash
poetry run mcp-verifiedhumancert
```
